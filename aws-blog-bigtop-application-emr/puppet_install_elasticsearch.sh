...
sudo wget https://raw.githubusercontent.com/hvivani/aws-big-data-blog/patch-1/aws-blog-bigtop-application-emr/bigtop-deploy/puppet/modules/elasticsearch/templates/elasticsearch.conf
